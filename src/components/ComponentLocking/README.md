...
- Sign up for an account on [Ably](https://ably.com/sign-up?utm_source=ably-labs&utm_medium=github&utm_campaign=component-locking) and get an API KEY.
...
- Run `yarn dev` or `npm run dev` and go to http://localhost:5173/component-locking
...
- [Visit our website](https://ably.com?utm_source=ably-labs&utm_medium=github&utm_campaign=component-locking)

---

[![Ably logo](https://static.ably.dev/badge-black.svg?serverless-websockets-quest)](https://ably.com?utm_source=ably-labs&utm_medium=github&utm_campaign=component-locking)
